...
3. Faça um clone desse repositório rodando: <br> `git clone https://github.com/joaoathaide/maratonadev.git`;
4. Entre na pasta rodando pelo terminal: `cd maratonadev`;
